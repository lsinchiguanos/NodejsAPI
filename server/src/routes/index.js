...
const { getBooks, searchBook, newBook, updBook, delBook } = require('../controllers/book');  // ruta de los métodos de book
const { getClientes, searchCliente, newCliente, delCliente, updCliente } = require('../controllers/cliente');  // ruta de los métodos de cliente
